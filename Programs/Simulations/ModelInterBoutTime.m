...
rflip = 0.19/median(IBI_exp); %/binsize
...
for tt = 0.22 %0.1:0.01:0.25
    ...
    dt = 10
    [fig1, fig2, binvals1, mv1, stdv1] = Spont.autocorrelationVSinterboutinterval_nonconsecutive(dX, IBIi, turn_thresh, dt, 'data ' );
    close(fig2)
    ...
    %theoretical fit
    theox = [0:0.01:binvals1(end)/binsize];
